...
| No. | Feature                      | Priority | Short Description                                                        |
| --: | ---------------------------- | -------- | ------------------------------------------------------------------------ |
|   1 | Login                        | MVP      | Allow users to sign in using their email and password.                   |
|   2 | Logout                       | MVP      | Sign users out and invalidate their current session.                     |
|   3 | Forgot / Reset Password      | Post-MVP | Allow users to recover or reset a forgotten password.                    |
|   4 | Refresh Token                | MVP      | Generate a new access token without requiring the user to log in again.  |
|   5 | User Management              | MVP      | Create, update, activate, deactivate, and manage user accounts.          |
|   6 | Role Management              | MVP      | Manage roles such as Admin, HR, Manager, and Employee.                   |
|   7 | Permission Management        | MVP      | Define permissions for accessing system resources and operations.        |
|   8 | Role Assignment              | MVP      | Assign one or more roles to a user account.                              |
|   9 | Employee Profile             | MVP      | Store and manage employee personal and employment information.           |
|  10 | Employee Contact Information | MVP      | Manage employee email addresses, phone numbers, and addresses.           |
|  11 | Employee Documents           | Post-MVP | Store contracts, resumes, certificates, and other employee documents.    |
|  12 | Emergency Contact            | Post-MVP | Manage emergency contact information for each employee.                  |
|  13 | Department Management        | MVP      | Create, update, deactivate, and manage company departments.              |
|  14 | Position Management          | MVP      | Manage job positions and titles within the organization.                 |
|  15 | Team Management              | Post-MVP | Create teams and assign employees to them.                               |
|  16 | Manager Reporting Line       | MVP      | Define the direct manager of each employee.                              |
|  17 | Employment Contract          | Post-MVP | Store and manage employee contract information.                          |
|  18 | Employment Status            | MVP      | Track statuses such as active, probation, suspended, and terminated.     |
|  19 | Work Location                | Post-MVP | Manage office, remote, and hybrid work locations.                        |
|  20 | Clock In                     | MVP      | Record when an employee starts working.                                  |
|  21 | Clock Out                    | MVP      | Record when an employee finishes working.                                |
|  22 | Break Tracking               | Post-MVP | Track employee break start times, end times, and durations.              |
|  23 | Attendance Record            | MVP      | Store and display employee attendance history.                           |
|  24 | Daily Timesheet              | MVP      | Summarize employee working hours for each day.                           |
|  25 | Weekly Timesheet             | MVP      | Summarize employee working hours for each week.                          |
|  26 | Manual Time Entry            | Post-MVP | Allow employees to manually add missing working time.                    |
|  27 | Timesheet Correction         | Post-MVP | Allow employees to request corrections to recorded working hours.        |
|  28 | Submit Timesheet             | MVP      | Submit a completed timesheet for manager approval.                       |
|  29 | Approve Timesheet            | MVP      | Allow managers to approve submitted timesheets.                          |
|  30 | Reject Timesheet             | MVP      | Allow managers to reject timesheets and provide a reason.                |
|  31 | Leave Type Management        | MVP      | Manage leave types such as annual, sick, unpaid, and maternity leave.    |
|  32 | Leave Balance                | MVP      | Track the remaining leave allowance of each employee.                    |
|  33 | Leave Request                | MVP      | Allow employees to submit leave requests.                                |
|  34 | Leave Approval               | MVP      | Allow managers or HR staff to approve or reject leave requests.          |
|  35 | Work Calendar                | Post-MVP | Manage employee and organizational working calendars.                    |
|  36 | Holiday Management           | Post-MVP | Configure public holidays and company holidays.                          |
|  37 | Shift Management             | Post-MVP | Create and manage employee work shifts.                                  |
|  38 | Shift Assignment             | Post-MVP | Assign employees to specific work shifts.                                |
|  39 | Overtime Request             | Post-MVP | Allow employees to request and record overtime work.                     |
|  40 | Project Management           | MVP      | Create, update, archive, and manage projects.                            |
|  41 | Project Member Management    | MVP      | Assign employees to projects and define their responsibilities.          |
|  42 | Project Status Tracking      | MVP      | Track project statuses such as planned, active, completed, or cancelled. |
|  43 | Project Budget               | Post-MVP | Define and monitor the budget of a project.                              |
|  44 | Task Management              | MVP      | Create, update, delete, and manage project tasks.                        |
|  45 | Task Assignment              | MVP      | Assign tasks to employees or project members.                            |
|  46 | Task Priority                | MVP      | Set task priority levels such as low, medium, high, and urgent.          |
|  47 | Task Deadline                | MVP      | Define start dates and deadlines for tasks.                              |
|  48 | Task Timer                   | MVP      | Track the time an employee spends working on a task.                     |
|  49 | Activity Summary             | Post-MVP | Summarize employee working activity and tracked time.                    |
|  50 | Idle Time Tracking           | Advanced | Detect and record periods when no activity is detected.                  |
|  51 | Hourly Rate                  | Post-MVP | Configure the hourly cost or pay rate of an employee.                    |
|  52 | Project Cost Calculation     | Post-MVP | Calculate project labor costs using approved working hours.              |
|  53 | Job Opening Management       | Post-MVP | Create and manage available job positions.                               |
|  54 | Candidate Profile            | Post-MVP | Store and manage candidate personal and professional information.        |
|  55 | Job Application              | Post-MVP | Manage applications submitted for job openings.                          |
|  56 | Candidate Pipeline           | Post-MVP | Track candidates through recruitment stages.                             |
|  57 | Interview Scheduling         | Post-MVP | Schedule interviews with candidates and interviewers.                    |
|  58 | Interview Feedback           | Post-MVP | Record interviewer comments, ratings, and recommendations.               |
|  59 | Offer Management             | Post-MVP | Create, send, accept, or reject employment offers.                       |
|  60 | Onboarding Checklist         | Post-MVP | Manage onboarding tasks for newly hired employees.                       |
|  61 | Employee Goal Management     | Post-MVP | Create and track individual employee goals.                              |
|  62 | Team Goal Management         | Post-MVP | Create and track goals assigned to teams.                                |
|  63 | Goal Progress Tracking       | Post-MVP | Monitor progress toward employee and team goals.                         |
|  64 | Performance Review           | Post-MVP | Conduct periodic employee performance evaluations.                       |
|  65 | Self-Assessment              | Post-MVP | Allow employees to evaluate their own performance.                       |
|  66 | Manager Assessment           | Post-MVP | Allow managers to evaluate employee performance.                         |
|  67 | Feedback Management          | Post-MVP | Manage manager, peer, and employee feedback.                             |
|  68 | Training Management          | Advanced | Create and manage employee training courses and development plans.       |
|  69 | Employee Dashboard           | MVP      | Display attendance, tasks, leave balance, and personal information.      |
|  70 | Manager Dashboard            | MVP      | Display team attendance, tasks, approvals, and performance information.  |
|  71 | HR Dashboard                 | MVP      | Display employee, recruitment, leave, and workforce information.         |
|  72 | Admin Dashboard              | MVP      | Display system usage, account, role, and configuration information.      |
|  73 | Employee Report              | MVP      | Generate reports about employee profiles and employment statuses.        |
|  74 | Attendance Report            | MVP      | Generate reports about attendance and working hours.                     |
|  75 | Leave Report                 | Post-MVP | Generate reports about leave requests, balances, and approvals.          |
|  76 | Project Report               | Post-MVP | Generate reports about projects, tasks, working hours, and costs.        |
|  77 | In-App Notification          | Post-MVP | Notify users about approvals, assignments, deadlines, and updates.       |
|  78 | Email Notification           | Post-MVP | Send important system notifications through email.                       |
|  79 | Audit Log                    | Post-MVP | Record important user actions and system changes.                        |
|  80 | Data Import / Export         | Post-MVP | Import or export system data using CSV or Excel files.                   |

## High-Priority Features to Implement First

| No. | Feature                | Priority | Short Description                                                          |
| --: | ---------------------- | -------- | -------------------------------------------------------------------------- |
|   1 | Login                  | Critical | Authenticate users before they access the system.                          |
|   2 | Logout                 | Critical | Securely terminate the current user session.                               |
|   3 | User Management        | Critical | Manage accounts used by employees, managers, HR staff, and administrators. |
|   4 | Role Management        | Critical | Control access through Admin, HR, Manager, and Employee roles.             |
|   5 | Employee Profile       | Critical | Store the main personal and employment information of an employee.         |
|   6 | Department Management  | High     | Organize employees into company departments.                               |
|   7 | Position Management    | High     | Define employee job titles and organizational positions.                   |
|   8 | Manager Reporting Line | High     | Assign a direct manager to each employee.                                  |
|   9 | Clock In               | Critical | Record when an employee begins working.                                    |
|  10 | Clock Out              | Critical | Record when an employee finishes working.                                  |
|  11 | Attendance Record      | Critical | Store employee clock-in and clock-out history.                             |
|  12 | Timesheet Management   | Critical | Summarize employee working hours by day or week.                           |
|  13 | Timesheet Approval     | High     | Allow managers to approve or reject submitted working hours.               |
|  14 | Leave Balance          | High     | Track the number of leave days available to each employee.                 |
|  15 | Leave Request          | High     | Allow employees to submit requests for time off.                           |
|  16 | Leave Approval         | High     | Allow managers or HR staff to approve or reject leave requests.            |
|  17 | Project Management     | High     | Create projects and manage their basic information and status.             |
|  18 | Task Management        | High     | Create, assign, prioritize, and monitor project tasks.                     |
|  19 | Task Timer             | High     | Track how much time employees spend on individual tasks.                   |
|  20 | Dashboard and Reports  | High     | Provide important workforce, attendance, leave, and project summaries.     |
